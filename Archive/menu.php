...
<div class="menu">
    <div class="container-fluid content">
        <div id="norm" class="top-bar">
            ...
            <ul class="nav nav-pills mb-3" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#op1" type="button" role="tab" aria-controls="op1" aria-selected="true">Manpower Outsourcing</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" data-bs-toggle="pill" data-bs-target="#op7" type="button" role="tab" aria-controls="op7" aria-selected="false">User</button>
                </li>
            </ul>
        ...
        <nav id="burger" class="navbar navbar-dark light-blue lighten-4">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                ...
                <ul class="navbar-nav mr-auto nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="op1-tab" data-bs-toggle="pill" data-bs-target="#op1" type="button" role="tab" aria-controls="op1" aria-selected="true">Manpower Outsourcing</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="op7-tab" data-bs-toggle="pill" data-bs-target="#op7" type="button" role="tab" aria-controls="op7" aria-selected="false">User</button>
                    </li>
                </ul>
                <!-- Links -->
        ...
        <div class="tab-content" id="cont">
            ...
            <div class="tab-pane fade" id="op7" role="tabpanel" aria-labelledby="op7-tab">
                <div class="info-box">
